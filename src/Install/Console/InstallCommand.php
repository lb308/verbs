...
class InstallCommand extends AbstractCommand
{
    ...
    protected function seedPermissions()
    {
        $permissions = [
            ...
            // Members can create and reply to verbs, and view the user list
            [Group::MEMBER_ID, 'startDiscussion'],
            [Group::MEMBER_ID, 'verb.reply'],
            [Group::MEMBER_ID, 'viewUserList'],

            // Moderators can edit + delete stuff
            [Group::MODERATOR_ID, 'verb.hide'],
            [Group::MODERATOR_ID, 'verb.editPosts'],
            [Group::MODERATOR_ID, 'verb.rename'],
            [Group::MODERATOR_ID, 'verb.viewIpsPosts'],
        ];
