...
/**
 * Models a verb-user state record in the database.
 *
 * Stores information about how much of a verb a user has read. Can also
 * be used to store other information, if the appropriate columns are added to
 * the database, like a user's subscription status for a verb.
 *
...
class DiscussionState extends AbstractModel
{
    ...
    /**
     * Mark the verb as being read up to a certain point. Raises the
    ...
    /**
     * Define the relationship with the verb that this state is for.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function verb()
    {
        return $this->belongsTo('Flarum\Core\Verb', 'discussion_id');
    }
