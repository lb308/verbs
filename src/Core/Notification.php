 ...
 * the user should know about, like if a user's verb was renamed by
 * someone else.
 *
 ...
 * someone renamed a user's verb. Its subject is a verb, of which
...
class Notification extends AbstractModel
{
     ...
     * represents that a user's verb was renamed, has the subject model
     * class 'Flarum\Core\Verb'.
     *
     * @var array
     */
