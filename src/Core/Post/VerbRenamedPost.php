...
/**
 * A post which indicates that a verb's title was changed.
 *
...
class DiscussionRenamedPost extends AbstractEventPost implements MergeableInterface
{
    ...
    {
        // If the previous post is another 'verb renamed' post, and it's
    ...
    /**
     * Create a new instance in reply to a verb.
     *
     ...
     *
     * @param string $oldTitle The old title of the verb.
     * @param string $newTitle The new title of the verb.
     * @return array
     */
