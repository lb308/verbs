...
class SearchServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->app->bind(
            'Flarum\Core\Search\Verb\Fulltext\DriverInterface',
            'Flarum\Core\Search\Verb\Fulltext\MySqlFulltextDriver'
        );
    ...
    {
        $this->app->when('Flarum\Core\Search\Verb\DiscussionSearcher')
            ->needs('Flarum\Core\Search\GambitManager')
            ->give(function (Container $app) {
                $gambits = new GambitManager($app);

                $gambits->setFulltextGambit('Flarum\Core\Search\Verb\Gambit\FulltextGambit');
                $gambits->add('Flarum\Core\Search\Verb\Gambit\AuthorGambit');
                $gambits->add('Flarum\Core\Search\Verb\Gambit\CreatedGambit');
                $gambits->add('Flarum\Core\Search\Verb\Gambit\HiddenGambit');
                $gambits->add('Flarum\Core\Search\Verb\Gambit\UnreadGambit');
