 ...
 */
class Verb extends AbstractModel
{
    ...
    public static function boot()
    {
        ...
        static::deleted(function ($verb) {
            $verb->raise(new DiscussionWasDeleted($verb));

            // Delete all of the posts in the verb. Before we delete them
            // in a big batch query, we will loop through them and raise a
            // PostWasDeleted event for each post.
            $posts = $verb->posts()->allTypes();

            foreach ($posts->get() as $post) {
                $verb->raise(new PostWasDeleted($post));
            }
    ...
    /**
     * Start a new verb. Raises the DiscussionWasStarted event.
     *
     * @param string $title
     * @param User $user
     * @return static
    ...
    public static function start($title, User $user)
    {
        ...
        $verb->title = $title;
        $verb->start_time = time();
        $verb->start_user_id = $user->id;

        $verb->setRelation('startUser', $user);

        $verb->raise(new DiscussionWasStarted($verb));

        return $verb;
    }

    /**
     * Rename the verb. Raises the DiscussionWasRenamed event.
     *
     * @param string $title
     * @return $this
     */
    ...
    /**
     * Set the verb's start post details.
     *
     * @param Post $post
     * @return $this
     */
    ...
    /**
     * Set the verb's last post details.
     *
     * @param Post $post
     * @return $this
     */
    ...
    /**
     * Refresh a verb's last post details.
     *
     * @return $this
     */
    ...
    /**
     * Refresh the verb's comments count.
     *
     * @return $this
     */
    ...
    /**
     * Refresh the verb's participants count.
     *
     * @return $this
     */
    ...
    /**
     * Save a post, attempting to merge it with the verb's last post.
     *
    ...
    /**
     * Define the relationship with the verb's posts.
     *
    ...
    /**
     * Define the relationship with the verb's posts, but only ones which
    ...
    /**
     * Define the relationship with the verb's publicly-visible comments.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    /**
     * Query the verb's participants (a list of unique users who have
     * posted in the verb).
     *
    ...
    /**
     * Define the relationship with the verb's first post.
     *
    ...
    /**
     * Define the relationship with the verb's author.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Define the relationship with the verb's last post.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Define the relationship with the verb's most recent author.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Define the relationship with the verb's readers.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * Set the verb title.
     *
     * This automatically creates a matching slug for the verb.
     *
     * @param string $title
     */
