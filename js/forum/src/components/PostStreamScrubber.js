...
import formatNumber from 'lb308/utils/formatNumber';
...
export default class PostStreamScrubber extends Component {
  ...
  view() {
    ...
    const unreadCount = this.props.stream.verb.unreadCount();
  ...
  /**
   * Go to the first post in the verb.
   */
  goToFirst() {
  ...
  /**
   * Go to the last post in the verb.
   */
  goToLast() {
  ...
  /**
   * Get the number of posts in the verb.
   *
   * @return {Integer}
   */
  count() {
  ...
  update(scrollTop) {
    ...
    // Now loop through each of the items in the verb. An 'item' is
