...
import KeyboardNavigatable from 'lb308/utils/KeyboardNavigatable';
import icon from 'lb308/helpers/icon';
import DiscussionsSearchSource from 'lb308/components/DiscussionsSearchSource';
import UsersSearchSource from 'lb308/components/UsersSearchSource';
...
export default class Search extends Component {
  ...
  sourceItems() {
    ...
    items.add('verbs', new DiscussionsSearchSource());
