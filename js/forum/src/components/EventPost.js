import Post from 'lb308/components/Post';
import { ucfirst } from 'lb308/utils/string';
import usernameHelper from 'lb308/helpers/username';
import icon from 'lb308/helpers/icon';

/**
 * The `EventPost` component displays a post which indicating a verb
 * event, like a verb being renamed or stickied. Subclasses must implement
