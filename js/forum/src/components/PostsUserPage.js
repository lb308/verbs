    ...
    return (
      <div className="PostsUserPage">
        <ul className="PostsUserPage-list">
          {this.posts.map(post => (
            <li>
              <div className="PostsUserPage-verb">
                {app.translator.trans('core.forum.user.in_discussion_text', {verb: <a href={app.route.post(post)} config={m.route}>{post.verb().title()}</a>})}
              </div>
