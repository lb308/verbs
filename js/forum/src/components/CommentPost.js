...
import PostUser from 'lb308/components/PostUser';
import PostMeta from 'lb308/components/PostMeta';
import PostEdited from 'lb308/components/PostEdited';
...
export default class CommentPost extends Post {
  ...
  content() {
    ...
    // weirdness in Mithril.js 0.1.x (see lb308/core#975). This workaround can
