 ...
 * this way, if a user visits a verb, and then visits another verb,
 * popping the history stack will still take them back to the verb list
 * rather than the previous verb.
 */
